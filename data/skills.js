...
window.SKILLS = [
  ...
  { id:"sentence-c1", category:"Sentence Structure", band:"C1", name:"Basic SVO", example:"She eats breakfast at 8.", introduced:true, mode:"progression", assessed:true, resources:{ sheets:[{name:"Simple Sentences",url:"https://kewhighschool.sharepoint.com/sites/KHSWritingHub/SitePages/CS-%C2%B7-Simple-Sentences.aspx"},{name:"Subjects",url:"https://kewhighschool.sharepoint.com/sites/KHSWritingHub/SitePages/CS-%C2%B7-Subjects.aspx"},{name:"Objects",url:"https://kewhighschool.sharepoint.com/sites/KHSWritingHub/SitePages/CS-%C2%B7-Objects.aspx"}] }, items:[
      ...
      { type:"gapfill", prompt:"Write the subject", before:"", after:"kicked the ball over the fence.", cue:"who?", accept:["he","she","the boy","the girl","tom","sam","mia"], explain:"A subject is needed before the verb kicked.", tags:["svo"] },
      ...
      { type:"order", prompt:"Put the words in the correct order", words:["school","to","goes","She"], answer:"She goes to school", explain:"Subject (She) + verb (goes) + rest (to school) = SVO order.", tags:["svo"] },
      { type:"order", prompt:"Put the words in the correct order", words:["the","reads","cat","book","a"], answer:"The cat reads a book", explain:"Subject (the cat) + verb (reads) + object (a book) = correct SVO.", tags:["svo"] },
      { type:"produce", prompt:"Write a simple sentence with subject, verb, and object", explain:"Teacher assessed. Check that it has subject + verb + object in order.", tags:["svo"] },
  ] },
  { id:"sentence-c2", category:"Sentence Structure", band:"C2", name:"Coordination", example:"He ran fast and won the race.", introduced:true, mode:"progression", assessed:true, resources:{ sheets:[{name:"Compound Sentences",url:"https://kewhighschool.sharepoint.com/sites/KHSWritingHub/SitePages/CS-%C2%B7-Compound-Sentences.aspx"},{name:"Conjunctions",url:"https://kewhighschool.sharepoint.com/sites/KHSWritingHub/SitePages/CS-%C2%B7-Conjunctions.aspx"}] }, items:[
      { type:"identify", prompt:"Choose the conjunction", sentence:"She likes maths ___ she hates science.", options:["and","but","or","so"], answer:"but", explain:"But joins two ideas that contrast.", tags:["coordination"] },
      { type:"identify", prompt:"Choose the conjunction", sentence:"We can walk ___ take the bus.", options:["and","but","or","so"], answer:"or", explain:"Or gives a choice between two options.", tags:["coordination"] },
      { type:"identify", prompt:"Choose the conjunction", sentence:"It was raining, ___ we stayed inside.", options:["and","but","or","so"], answer:"so", explain:"So shows a result or consequence.", tags:["coordination"] },
      { type:"gapfill", prompt:"Add the correct conjunction", before:"He studied hard", after:"he passed the test.", cue:"and / but / so", accept:["and","so"], explain:"And or so both work: he studied hard and/so he passed.", tags:["coordination"] },
      { type:"gapfill", prompt:"Add the correct conjunction", before:"She was tired", after:"she kept working.", cue:"and / but / so", accept:["but"], explain:"But shows contrast: tired yet kept working.", tags:["coordination"] },
      { type:"gapfill", prompt:"Add the correct conjunction", before:"Do you want tea", after:"coffee?", cue:"and / or / but", accept:["or"], explain:"Or offers a choice between tea and coffee.", tags:["coordination"] },
      { type:"choose", prompt:"Which sentence uses 'and' correctly?", options:["She likes maths and science.","She likes maths and she hates science.","She likes maths, and science is hard.","She likes maths and wants to study it."], answer:"She likes maths and science.", explain:"'And' joins two ideas of equal weight: she likes both maths and science.", tags:["coordination"] },
      { type:"choose", prompt:"Which shows a contrast?", options:["He was tall and strong.","He was tired, so he slept.","He was tired, but he kept working.","He studied and passed the test."], answer:"He was tired, but he kept working.", explain:"'But' shows contrast: expected to stop (tired) yet continued (kept working).", tags:["coordination"] },
      { type:"join", prompt:"Join with 'and'", sentence1:"The dog barked loudly.", sentence2:"The cat ran away.", accept:["the dog barked loudly and the cat ran away","and the cat ran away","the dog barked loudly and the cat", "the dog barked and the cat ran away"], explain:"'And' joins two ideas of equal importance. Both sentences needed and connected.", tags:["coordination"] },
      { type:"join", prompt:"Join with 'but'", sentence1:"It was very cold.", sentence2:"We went swimming anyway.", accept:["it was very cold but we went swimming anyway","but we went swimming anyway","it was cold but we went swimming"], explain:"'But' shows contrast between two ideas: cold yet swimming anyway.", tags:["coordination"] },
      { type:"join", prompt:"Join with 'so'", sentence1:"She forgot her homework.", sentence2:"The teacher gave her extra time.", accept:["she forgot her homework so the teacher gave her extra time","so the teacher gave her extra time","she forgot so the teacher gave her extra time"], explain:"'So' shows a result or consequence: forgot, therefore teacher helped.", tags:["coordination"] },
  ] },
  { id:"sentence-c3", category:"Sentence Structure", band:"C3", name:"Subordination", example:"Although it was raining, we went out.", introduced:true, mode:"progression", assessed:true, resources:{ sheets:[{name:"Complex Sentences",url:"https://kewhighschool.sharepoint.com/sites/KHSWritingHub/SitePages/CS-%C2%B7-Complex-Sentences.aspx"},{name:"Clauses",url:"https://kewhighschool.sharepoint.com/sites/KHSWritingHub/SitePages/CS-%C2%B7-Clauses.aspx"}] }, items:[
      { type:"identify", prompt:"Find the subordinating conjunction", sentence:"Because it was hot, we went swimming.", options:["Because","it was","hot","we went"], answer:"Because", explain:"Because introduces the reason clause (subordinate clause).", tags:["subordination"] },
      { type:"identify", prompt:"Find the subordinating conjunction", sentence:"She left early although she wanted to stay.", options:["She","early","although","wanted"], answer:"although", explain:"Although introduces a contrast clause.", tags:["subordination"] },
      { type:"identify", prompt:"Which is the subordinate clause?", sentence:"When the bell rang, the students stood up.", options:["When the bell rang","the students stood up","the students","stood up"], answer:"When the bell rang", explain:"The when-clause depends on the main clause; it cannot stand alone.", tags:["subordination"] },
      { type:"gapfill", prompt:"Add the subordinating conjunction", before:"", after:"she finished her homework, she went outside.", cue:"after / because / although", accept:["after"], explain:"After shows time order: finishing homework came first.", tags:["subordination"] },
      { type:"gapfill", prompt:"Add the subordinating conjunction", before:"He wore a jacket", after:"it was cold.", cue:"because / although / when", accept:["because"], explain:"Because gives the reason for wearing a jacket.", tags:["subordination"] },
      { type:"gapfill", prompt:"Add the subordinating conjunction", before:"We will start the game", after:"everyone arrives.", cue:"when / because / although", accept:["when"], explain:"When shows the time the game will start.", tags:["subordination"] },
  ] },
  { id:"sentence-c4", category:"Sentence Structure", band:"C4/C4+", name:"Cleft / Emphatic", example:"It was Mia who solved the problem.", introduced:true, mode:"progression", assessed:true, resources:{ sheets:[{name:"Varying Sentence Openings",url:"https://kewhighschool.sharepoint.com/sites/KHSWritingHub/SitePages/CS-%C2%B7-Varying-Sentence-Openings.aspx"},{name:"Cumulative and Periodic Sentences",url:"https://kewhighschool.sharepoint.com/sites/KHSWritingHub/SitePages/CS-%C2%B7-Cumulative-and-Periodic-Sentences.aspx"}] }, items:[
      ...
      { type:"identify", prompt:"What is being emphasised?", sentence:"It was Liam who broke the window.", options:["Liam","the window","broke","who"], answer:"Liam", explain:"The cleft structure puts Liam in the focus position.", tags:["cleft"] },
  ...
  { id:"tense-c1", category:"Verb Tenses", band:"C1", name:"Present Simple/Continuous, Past Simple", example:"I live in Melbourne. I am learning English.", introduced:true, mode:"progression", assessed:true, resources:{ sheets:[{name:"Verbs",url:"https://kewhighschool.sharepoint.com/sites/KHSWritingHub/SitePages/CS-%C2%B7-Verbs.aspx"},{name:"Tense Consistency",url:"https://kewhighschool.sharepoint.com/sites/KHSWritingHub/SitePages/CS-%C2%B7-Tense-Consistency.aspx"}] }, items:[
      ...
      { type:"produce", prompt:"Write two sentences: one in present simple, one in past simple", explain:"Teacher assessed. Check for correct tense forms and completed sentences.", tags:["present-simple","past-simple"] },
  ]},
  ...
  { id:"modality-c2", category:"Modality", band:"C2", name:"May / Might", example:"It might rain tomorrow.", introduced:true, mode:"progression", assessed:true, resources:{ sheets:[{name:"Auxiliary and Modal Verbs",url:"https://kewhighschool.sharepoint.com/sites/KHSWritingHub/SitePages/CS-%C2%B7-Auxiliary-and-Modal-Verbs.aspx"}] }, items:[
  ...
  { id:"passive-c1", category:"Passive Voice", band:"C1", name:"Intro to Passive", example:"The letter was sent yesterday.", introduced:true, mode:"progression", assessed:true, resources:{ sheets:[{name:"Verbs",url:"https://kewhighschool.sharepoint.com/sites/KHSWritingHub/SitePages/CS-%C2%B7-Verbs.aspx"}] }, items:[
      ...
      { type:"gapfill", prompt:"Rewrite in the passive", before:"The letter", after:"yesterday.", cue:"send", accept:["was sent"], explain:"Passive past = was + past participle: was sent.", tags:["passive-intro"] },
      { type:"gapfill", prompt:"Rewrite in the passive", before:"The homework", after:"by the teacher.", cue:"check", accept:["was checked"], explain:"Passive past = was + past participle: was checked.", tags:["passive-intro"] },
      { type:"gapfill", prompt:"Rewrite in the passive", before:"English", after:"in many countries.", cue:"speak", accept:["is spoken"], explain:"Passive present = is + past participle: is spoken.", tags:["passive-intro"] },
      { type:"transform", prompt:"Rewrite in the passive", sentence:"My brother painted the fence.", accept:["the fence was painted by my brother","the fence was painted","the fence was painted by my brother"], explain:"Active: my brother (subject) painted (verb) the fence. Passive: the fence (subject) was painted by my brother.", tags:["passive-intro"] },
      { type:"transform", prompt:"Rewrite in the passive", sentence:"The teacher marked all the homework.", accept:["all the homework was marked by the teacher","all the homework was marked","the homework was marked"], explain:"Active: teacher did the action. Passive: homework received the action and becomes the subject.", tags:["passive-intro"] },
  ] },
  { id:"passive-c2", category:"Passive Voice", band:"C2", name:"Present / Past Passive", example:"These shoes were made in Italy.", introduced:true, mode:"progression", assessed:true, resources:{ sheets:[{name:"Verbs",url:"https://kewhighschool.sharepoint.com/sites/KHSWritingHub/SitePages/CS-%C2%B7-Verbs.aspx"}] }, items:[
  ...
  { id:"passive-c4", category:"Passive Voice", band:"C4/C4+", name:"Passive Reporting", example:"The manager is said to have resigned.", introduced:true, mode:"progression", assessed:true, resources:{ sheets:[{name:"Verbs",url:"https://kewhighschool.sharepoint.com/sites/KHSWritingHub/SitePages/CS-%C2%B7-Verbs.aspx"}] }, items:[
  ...
  { id:"agree-c2", category:"Agreement & Number", band:"C2", name:"Regular / Irregular Plurals", example:"one child, two children", introduced:true, mode:"progression", assessed:false, resources:{ sheets:[{name:"Nouns",url:"https://kewhighschool.sharepoint.com/sites/KHSWritingHub/SitePages/CS-%C2%B7-Nouns.aspx"}] }, items:[
  ...
  { id:"agree-c3", category:"Agreement & Number", band:"C3", name:"Countable / Uncountable & Quantifiers", example:"much water, many bottles", introduced:true, mode:"progression", assessed:false, resources:{ sheets:[{name:"Nouns",url:"https://kewhighschool.sharepoint.com/sites/KHSWritingHub/SitePages/CS-%C2%B7-Nouns.aspx"}] }, items:[
  ...
  { id:"agree-c4", category:"Agreement & Number", band:"C4/C4+", name:"Collective / Complex Subjects", example:"The team is winning. The team are arguing.", introduced:true, mode:"progression", assessed:false, resources:{ sheets:[{name:"Subject-Verb Agreement",url:"https://kewhighschool.sharepoint.com/sites/KHSWritingHub/SitePages/CS-%C2%B7-Subject-Verb-Agreement.aspx"}] }, items:[
      { type:"identify", prompt:"Singular or plural verb?", sentence:"The team <b>is</b> playing well today.", options:["singular (the team as one unit)","plural (the team as individuals)"], answer:"singular (the team as one unit)", explain:"The team acts as one unit here = singular verb.", tags:["collective"] },
      { type:"identify", prompt:"Singular or plural verb?", sentence:"The class <b>are</b> working on different projects.", options:["plural (the class as individuals)","singular (the class as one unit)"], answer:"plural (the class as individuals)", explain:"Each student does a different thing = plural verb.", tags:["collective"] },
  ...
  { id:"question-c1", category:"Questions & Negation", band:"C1", name:"Yes/No Questions & Basic Negation", example:"Do you like it? I don't like it.", introduced:true, mode:"progression", assessed:false, resources:{ sheets:[{name:"Auxiliary and Modal Verbs",url:"https://kewhighschool.sharepoint.com/sites/KHSWritingHub/SitePages/CS-%C2%B7-Auxiliary-and-Modal-Verbs.aspx"}] }, items:[
      { type:"identify", prompt:"Question or statement?", sentence:"<b>Does she like</b> chocolate?", options:["question","statement"], answer:"question", explain:"Does + subject + verb = yes/no question.", tags:["yes-no"] },
