...
window.SKILLS = [
  ...
  { id:"sentence-c1", category:"Sentence Structure", band:"C1", name:"Basic SVO", example:"She eats breakfast at 8.", introduced:true, mode:"progression", assessed:true, resources:null, items:[
      { type:"identify", prompt:"Find the verb", sentence:"The dog <b>chased</b> the cat.", options:["The dog","chased","the cat","dog chased"], answer:"chased", explain:"The verb is the action word: chased.", tags:["svo"] },
      { type:"identify", prompt:"Find the subject", sentence:"<b>My brother</b> plays guitar after school.", options:["My brother","plays","guitar","after school"], answer:"My brother", explain:"The subject is who does the action: my brother.", tags:["svo"] },
  ...
  { id:"sentence-c2", category:"Sentence Structure", band:"C2", name:"Coordination", example:"He ran fast and won the race.", introduced:true, mode:"progression", assessed:true, resources:null, items:[
      { type:"identify", prompt:"Name the conjunction", sentence:"She likes maths <b>but</b> she hates science.", options:["and","but","or","so"], answer:"but", explain:"But joins two ideas that contrast.", tags:["coordination"] },
      { type:"identify", prompt:"Name the conjunction", sentence:"We can walk <b>or</b> take the bus.", options:["and","but","or","so"], answer:"or", explain:"Or gives a choice between two options.", tags:["coordination"] },
      { type:"identify", prompt:"Name the conjunction", sentence:"It was raining, <b>so</b> we stayed inside.", options:["and","but","or","so"], answer:"so", explain:"So shows a result or consequence.", tags:["coordination"] },
  ...
  { id:"sentence-c3", category:"Sentence Structure", band:"C3", name:"Subordination", example:"Although it was raining, we went out.", introduced:true, mode:"progression", assessed:true, resources:null, items:[
      { type:"identify", prompt:"Find the subordinating conjunction", sentence:"<b>Because</b> it was hot, we went swimming.", options:["Because","it was","hot","we went"], answer:"Because", explain:"Because introduces the reason clause (subordinate clause).", tags:["subordination"] },
      { type:"identify", prompt:"Find the subordinating conjunction", sentence:"She left early <b>although</b> she wanted to stay.", options:["She","early","although","wanted"], answer:"although", explain:"Although introduces a contrast clause.", tags:["subordination"] },
      { type:"identify", prompt:"Which is the subordinate clause?", sentence:"<b>When the bell rang</b>, the students stood up.", options:["When the bell rang","the students stood up","the students","stood up"], answer:"When the bell rang", explain:"The when-clause depends on the main clause; it cannot stand alone.", tags:["subordination"] },
  ...
  { id:"sentence-c4", category:"Sentence Structure", band:"C4/C4+", name:"Cleft / Emphatic", example:"It was Mia who solved the problem.", introduced:true, mode:"progression", assessed:true, resources:null, items:[
      ...
      { type:"identify", prompt:"What is being emphasised?", sentence:"It was <b>Liam</b> who broke the window.", options:["Liam","the window","broke","who"], answer:"Liam", explain:"The cleft structure puts Liam in the focus position.", tags:["cleft"] },
  ...
  { id:"relative-c1", category:"Relative Clauses", band:"C1", name:"Intro (who/which)", example:"That's the woman who helped me.", introduced:true, mode:"progression", assessed:true, resources:null, items:[
      { type:"identify", prompt:"Which relative pronoun?", sentence:"That is the boy <b>who</b> won the race.", options:["who","which","that","where"], answer:"who", explain:"Who refers to a person.", tags:["who"] },
      { type:"identify", prompt:"Which relative pronoun?", sentence:"She found the book <b>which</b> was on the table.", options:["which","who","where","when"], answer:"which", explain:"Which refers to a thing.", tags:["which"] },
  ...
  { id:"question-c2", category:"Questions & Negation", band:"C2", name:"Wh- Questions", example:"Where did she go?", introduced:true, mode:"progression", assessed:false, resources:null, items:[
      { type:"identify", prompt:"Which question word?", sentence:"<b>Where</b> did you buy that shirt?", options:["Where","What","When","Who"], answer:"Where", explain:"Where asks about place.", tags:["wh-question"] },
      { type:"identify", prompt:"Which question word?", sentence:"<b>Why</b> were you late?", options:["Why","When","How","Where"], answer:"Why", explain:"Why asks about reason.", tags:["wh-question"] },
  ...
  { id:"question-c3", category:"Questions & Negation", band:"C3", name:"Inversion & Question Tags", example:"You're coming, aren't you?", introduced:true, mode:"progression", assessed:false, resources:null, items:[
      { type:"identify", prompt:"What is the question tag?", sentence:"She is from Melbourne, <b>isn't she</b>?", options:["isn't she","is she","aren't she","does she"], answer:"isn't she", explain:"Positive statement + negative tag: is -> isn't she.", tags:["question-tag"] },
      { type:"identify", prompt:"What is the question tag?", sentence:"They don't like fish, <b>do they</b>?", options:["do they","don't they","are they","did they"], answer:"do they", explain:"Negative statement + positive tag: don't -> do they.", tags:["question-tag"] },
  ...
  { id:"prep-pool",    category:"Prepositions", band:null, name:"Prepositions (practice pool)", example:"The book is on the table.", introduced:true, mode:"pool", assessed:false, resources:null, items:[
      ...
      { type:"identify", prompt:"Which preposition is correct?", sentence:"She is good <b>at</b> maths.", options:["at","in","on","for"], answer:"at", explain:"good at + subject = fixed preposition.", tags:["preposition"] },
      { type:"identify", prompt:"Which preposition is correct?", sentence:"He is interested <b>in</b> science.", options:["in","at","on","about"], answer:"in", explain:"interested in = fixed preposition.", tags:["preposition"] },
  ] },
